...
//     {
//       icon: Mic,
//       title: 'Evaluator Perception Simulation',
//       description: 'Discover how interviewers, investors, and examiners perceive your speech under pressure with AI-powered risk detection.',
//       color: 'from-blue-500 to-primary-600'
//     },
//     {
//       icon: TrendingUp,
//       title: 'Communication Trajectory',
//       description: 'Track how your evaluator confidence scores evolve across different high-stakes contexts.',
//       color: 'from-purple-500 to-pink-500'
//     },
//     {
//       icon: Award,
//       title: 'Context-Specific Scenarios',
//       description: 'Train with scenarios that mirror real evaluation contexts: interviews, pitches, and oral exams.',
//       color: 'from-green-500 to-emerald-600'
//     },
//     {
//       icon: BarChart3,
//       title: 'Perception Signals',
//       description: 'Identify trust-breaking pauses, hesitation clusters, and engagement risks that undermine evaluator confidence.',
//       color: 'from-orange-500 to-red-500'
//     },
//     {
//       icon: Target,
//       title: 'Communication Risk Assessment',
//       description: 'Understand which speech patterns undermine evaluator trust and how to eliminate them from critical responses.',
//       color: 'from-cyan-500 to-blue-600'
//     },
//     {
//       icon: Zap,
//       title: 'Opinionated AI Judgments',
//       description: 'Get explicit evaluator-perspective feedback: no neutral analytics, only decision-impact insights.',
...
//       description: 'Users achieve stable perception scores within 30 days'
//     },
//     {
//       stat: '24/7',
//       label: 'Evaluator Simulation',
//       description: 'Practice high-stakes responses with instant perception analysis'
//     },
//     {
//       stat: '100%',
//       label: 'Free Forever',
...
//                 Simulate how interviewers, investors, and examiners perceive your speech under pressure. 
//                 Identify trust-breaking moments and eliminate communication risk before it costs you the opportunity.
//               </p>
...
//                     <h3 className="font-semibold text-gray-900 dark:text-white">Evaluator Perception</h3>
...
//                         <span className="text-gray-700 dark:text-gray-300">Evaluator Confidence</span>
...
//                     <div>
//                       <div className="flex justify-between text-sm mb-1">
//                         <span className="text-gray-700 dark:text-gray-300">Trust Stability</span>
...
//       {/* Footer */}
//       <footer className="py-12 px-4 sm:px-6 lg:px-8 border-t dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
//         <div className="max-w-7xl mx-auto">
//           {/* Developers Section */}
//           <div className="mb-8">
...
//               {/* Developer 1 - Ayush Chaudhary */}
//               <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow border border-gray-200 dark:border-gray-700">
...
//                     <a
//                       href="https://www.linkedin.com/in/ayush23chaudhary/"
//                       target="_blank"
...
//                     </a>
//                     <a
//                       href="mailto:ayush23chaudhary@gmail.com"
...
//                   <div className="flex flex-col space-y-2 w-full">
//                     <a
//                       href="https://www.linkedin.com/in/akshat-kumar-6791092b5/"
//                       target="_blank"
//                       rel="noopener noreferrer"
//                       className="flex items-center justify-center space-x-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors"
//                     >
...
//                     </a>
//                     <a
//                       href="mailto:masterak2443@gmail.com"
//                       className="flex items-center justify-center space-x-2 px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors"
//                     >
//                       <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                         <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
