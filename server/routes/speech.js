...
const generateMockAnalysis = () => {
  ...
  const transcript = "Hello, this is a sample speech analysis. Um, I think that speaking clearly is important. Ah, it helps with communication. You know, when we speak with confidence, people listen better. So, practice makes perfect.";
